...
<br/>
	...
	<!-- form start -->	
		...
		<form class="form-container" action="${pageContext.request.contextPath}/updationsuccess" method="POST">
			...
			<div class="mb-3">
				<label  class="form-label">Phone Number</label> <font color="red"> ${errorPhone}</font> 
					<input name="phone" type="number" class="form-control"  value="${phone_no}" />
			</div>
			<div class="mb-3">
				<label  class="form-label">E-mail </label> <font color="red"> ${errorEmail}</font>
					 <input name="mail" type="text" class="form-control" value="${e_mail}" />
			</div>
			<div class="mb-3">
				<label  class="form-label">Type of Loan <i> (Home Loan, Personal Loan, Student Loan, Car Loan, Business Loan) </i> </label> 
						<input name="loan_type" type="text" class="form-control"  value="${loan_type}" />  
			</div>
			<div class="mb-3">
				<label  class="form-label">Loan Amount</label> 
					<input name="loan_amount" type="number" class="form-control"   value="${amount}"/>
			</div>
			<div class="mb-3">
				<label  class="form-label">Tenure <i>(in year)</i></label> 
					<input name="tenure" type="number" class="form-control" value="${tenure}" />
			</div>
			<div class="mb-3">
				<label  class="form-label">Annual Income</label><font color="red"> ${errorMessage}</font> 
					<input name="annual_income" type="number" class="form-control"value="${income}" />
			</div>
			<div class="mb-3">
				<label  class="form-label">Aadhaar Number</label> 
					<input name="aadhaar" type="number" class="form-control" value="${aadhaar}"  />
			</div>
			<div class="mb-3">
				<label>Pan Number</label> 
					<input name="pan" type="text" class="form-control" value="${pan}" />
			</div>
