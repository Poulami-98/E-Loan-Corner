...
<br/>
	<div class=container>
		<h1><font color="green">Updation of Your Loan Application Successful !!</font></h1>
		<p><font color="red"><i>Your application is submitted.<br/> 
		Your Application ID is <big>' ${loanId} '</big>.<br/> 
		You will be receiving further notification from bank.</i></font></p>
		<h2>Thank you for choosing Quick-E Bank</h2><br><br>
	</div>
	<div>
	<p style="margin-left : 5.7cm">
			<a class="btn btn-success" href="/register" role="button">back</a>
			
			<a class="btn btn-success" href="update/${loanId}" role="button">click here for update again</a>
			</p>
	</div>
