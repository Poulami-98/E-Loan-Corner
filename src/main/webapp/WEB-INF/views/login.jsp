...
<html>
  <head>
    ...
    <style type="text/css">
		...
		.navbar-custom {
  			background-color: #7a8881; /* Soft Sage Green */
		...
		/* Change link color to red on hover or focus */
  ...
  <!--<body
    background="https://i.pinimg.com/originals/5e/08/57/5e0857cd8f8204ae4415a2ba77569037.jpg"
  > -->
    ...
    >
      <div class="container-fluid">
        <i><font color="white"><b>E-Loan Corner</b></font></i>
        <button
        ...
        <div class="collapse navbar-collapse" id="navbarmenu">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link" href="/bankpolicy"
                >Bank Policy for Loan Approval</a
              >
            </li>
          </ul>
        </div>
	...
	<section class="hero">
		<h1 class="hero-heading">Empower Your Ambitions with Smart Lending</h1>
		<p class="hero-subheading">Borrow smarter with custom plans designed around your goals.</p>
	</section>
      ...
      <video
        ...
        height="auto"
      >
        <source src="/videos/8815371.mp4#t=0.001" type="video/mp4" />
    ...
    <div class="container">
      <div class="row">
        <div class="col">
          <div class="card" style="width: 20rem">
            ...
            <div class="card-body">
              ...
              <p class="card-text">
                A home loan is an amount of money that is borrowed from a bank
                or money lending company at...
              </p>
        ...
        <div class="col ml-5">
          <div class="card" style="width: 20rem">
            ...
            <div class="card-body">
              ...
              <p class="card-text">
                The Student Loan Scheme aims at providing financial support from
                the bank to deserving...
              </p>
        ...
        <div class="col ml-5">
          <div class="card" style="width: 20rem">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSgfSXLQm1HQ8ouWtwqB0T2fY2uNYrDdD-EWQ&s"
              class="card-img-top"
              alt="Card Thtee"
            />
            <div class="card-body">
              ...
              <p class="card-text">
                A car loan is a sum of money a consumer borrows in order to
                purchase a car...
              </p>
      ...
      <div class="row">
        <div class="col">
          <div class="card" style="width: 20rem">
            <img
              src="https://www.oneindia.com/img/2019/06/personal-loan-1560234151.jpg"
              class="card-img-top"
              alt="Card One"
            />
            <div class="card-body">
              ...
              <p class="card-text">
                A personal loan is an amount of money you can borrow to use for
        ...
        <div class="col ml-5">
          <div class="card" style="width: 20rem">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTR-RgAOIrRaB3GhQyigArkLGJkDiaKfWQeMksBQO3zFX7gr8ImkgteJHLEf-nkf7pBhYU&usqp=CAU"
              class="card-img-top"
              alt="Card Two"
            />
            <div class="card-body">
              ...
              <p class="card-text">
                ...
                business expenses -- from paying staff wages to.....
              </p>
        ...
        <div class="col ml-5">
          <div class="card" style="width: 20rem">
            <img
              src="https://m.economictimes.com/thumb/msid-81406782,width-1200,height-900,resizemode-4,imgsize-322938/home-loan-emi-calculation.jpg"
              class="card-img-top"
              alt="Card Thtee"
            />
            <div class="card-body">
              ...
              <p class="card-text">
                Calculate your EMI amount using this EMI calculator even before
                taking the loan.
              </p>
      ...
      <div class="row">
        <div class="col">
          <div class="card" style="width: 20rem">
            <img
              src="https://t3.ftcdn.net/jpg/01/57/34/62/360_F_157346244_A6Oml9kXsQdK3WaVVg91UnzheU0YeFpe.jpg"
              class="card-img-top"
              alt="Card One"
            />
            <div class="card-body">
        ...
        <div class="col ml-5">
          <div class="card" style="width: 20rem">
            <img
              src="https://cdn.phpjabbers.com/files/frees/simple-php-user-login-script.jpg"
              class="card-img-top"
              alt="Card Two"
            />
            <div class="card-body">
        ...
        <div class="col ml-5">
          <div class="card" style="width: 20rem">
            <img
              src="https://www.dialabank.com/wp-content/uploads/2019/11/applying-loan-f.png"
              class="card-img-top"
              alt="Card Thtee"
            />
            <div class="card-body">
              ...
              <p class="card-text">
                Customers are requested to register here for new loan.
              </p>
      ...
      <br />
      <br />
      <footer>&copy;E-Loan Corner</footer>
    </div>
